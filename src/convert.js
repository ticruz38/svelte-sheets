...
exports.convert = exports.getIdFromColumnName = exports.getColumnNameFromId = exports.getColumnName = void 0;
...
function convert(workbook) {
    ...
    workbook.SheetNames.forEach(function (sheetName) {
        ...
        var maxColumns = spreadsheet.data.reduce(function (acc, cur) { return (cur.length > acc ? (acc = cur.length) : acc); }, 0);
