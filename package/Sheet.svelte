...
import { clearSelection, computeStyles, deleteSelection, GetColSpan, GetRowSpan, mergeSelectExtends, pasteSelection, } from "./utilities";
export let data = [];
export let columns = [];
let xcolumns = [];
export let rows = [];
...
function onMouseOver(e) {
    ...
    if (!!edition)
        return;
    if (!!selected && !selection && extension && ((_b = (_a = e.target) === null || _a === void 0 ? void 0 : _a.dataset) === null || _b === void 0 ? void 0 : _b.x)) {
        if (
        // extended is inside selected
        ((_d = (_c = e.target) === null || _c === void 0 ? void 0 : _c.dataset) === null || _d === void 0 ? void 0 : _d.x) >= topLeft.c &&
            ((_f = (_e = e.target) === null || _e === void 0 ? void 0 : _e.dataset) === null || _f === void 0 ? void 0 : _f.x) < bottomRight.c &&
            ((_h = (_g = e.target) === null || _g === void 0 ? void 0 : _g.dataset) === null || _h === void 0 ? void 0 : _h.y) >= topLeft.r &&
            ((_k = (_j = e.target) === null || _j === void 0 ? void 0 : _j.dataset) === null || _k === void 0 ? void 0 : _k.y) < bottomRight.r) {
            extended = [
                encode(topLeft),
                encode({
        ...
        if (((_m = (_l = e.target) === null || _l === void 0 ? void 0 : _l.dataset) === null || _m === void 0 ? void 0 : _m.y) >= topLeft.r &&
            ((_p = (_o = e.target) === null || _o === void 0 ? void 0 : _o.dataset) === null || _p === void 0 ? void 0 : _p.y) < bottomRight.r) {
            extended = [
                squareX < 0
        ...
        if (((_r = (_q = e.target) === null || _q === void 0 ? void 0 : _q.dataset) === null || _r === void 0 ? void 0 : _r.x) >= topLeft.c &&
            ((_t = (_s = e.target) === null || _s === void 0 ? void 0 : _s.dataset) === null || _t === void 0 ? void 0 : _t.x) < bottomRight.c) {
            extended = [
                squareY < 0
    ...
    if (selection && !!selected && ((_v = (_u = e.target) === null || _u === void 0 ? void 0 : _u.dataset) === null || _v === void 0 ? void 0 : _v.x)) {
        selected = [
            selected[0] ||
                encode({
                    c: e.target.dataset.x,
